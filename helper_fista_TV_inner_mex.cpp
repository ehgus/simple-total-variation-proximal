 ...
 *
 * Input Structure: z = helper_fista_TV_inner_gpu(z, lambda_single, is_real, has_dirichlet_boundary, inner_iteration_unit32, min_real_single, max_real_single, min_imag_single, max_imag_single, boundary_value_single);
 */
